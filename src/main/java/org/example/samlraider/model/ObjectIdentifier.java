...
public final class ObjectIdentifier {
    ...
    private static final Map<String, String> extendedKeyUsageMap;
    private static final Map<Integer, String> subjectAlternativeNamesMap;
    private static final Map<Integer, String> keyUsageMap;
    private static final HashMap<String, Integer> x509keyUsage;
    private static final HashMap<String, KeyPurposeId> x509KeyPurpose;
    private static final HashMap<String, Integer> x509SubjectAlternativeName;
    private static final List<String> signatureAlgorithms;
    private static final List<String> publicKeyAlgorithms;
