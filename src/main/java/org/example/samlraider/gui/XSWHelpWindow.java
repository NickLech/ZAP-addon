...
public class XSWHelpWindow extends JFrame {
    ...
    public XSWHelpWindow() {
        ...
        JLabel lblDescription =
                new JLabel(
                        "<html>With xml wrapping attacks you try to trick the xml signature validator into validating an "
                                + "signature of an element while evaluating an other element. The XSWs in the image are supported."
                                + "<br/>The blue element represents the signature."
                                ...
                                + "<br/> Please check out this paper for further information."
                                + "</html>");
