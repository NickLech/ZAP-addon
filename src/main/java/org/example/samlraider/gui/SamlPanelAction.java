...
import org.example.samlraider.application.SamlTabController;
...
public class SamlPanelAction extends JPanel {
    ...
    //                        "Enter Burp Collaborator URL (e.g.
    // https://xyz.burpcollaborator.net)");
    //                if (collabUrl != null) {
    ...
    //        dialogPanel.add(new JLabel("Match and replace rules takes effect after apply XSW"),
    // BorderLayout.NORTH);
    //
    ...
    //                    matchAndReplaceMap.put(matchInputText.getText(),
    // replaceInputText.getText());
    //                    updateMatchAndReplaceList(listPanel, matchInputText, replaceInputText,
    // addEntryButton);
    ...
    //        updateMatchAndReplaceList(listPanel, matchInputText, replaceInputText,
    // addEntryButton);
    //        JOptionPane.showMessageDialog(this, listPanel, "Apply XSW - Match and Replace",
    // JOptionPane.PLAIN_MESSAGE);
    //    }
    //
    //    private void updateMatchAndReplaceList(JPanel listPanel, JTextField matchInputText,
    // JTextField replaceInputText, JButton addEntryButton) {
    //        HashMap<String, String> matchAndReplaceMap = controller.getMatchAndReplaceMap();
