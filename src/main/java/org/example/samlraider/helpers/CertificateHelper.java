...
public final class CertificateHelper {
     ...
     *
     * @param date Date as a String. Supported formats are "MMM d HH:mm:ss yyy ZZZ" (Eg. Aug 15
     *     10:56:49 2012 GMT) and "EEE MMM d HH:mm:ss ZZZ yyy" (Eg. Thu Mar 26 01:00:00 CET 2015)
     * @return Date object
    ...
    public static Date stringToDate(String date) throws ParseException, IllegalArgumentException {
        ...
        pattern =
                Pattern.compile(
                        "[A-Z][a-z]{2} [0-9]{1,2} ([0-9]{2}:){1,2}[0-9]{2} [0-9]{4} [A-Z]{3}");
        ...
        pattern =
                Pattern.compile(
                        "[A-Z][a-z]{2} [A-Z][a-z]{2} [0-9]{1,2} ([0-9]{2}:){1,2}[0-9]{2} [A-Z]{3,4} [0-9]{4}");
        if (pattern.matcher(date).matches()) {
    ...
    /**
     * Converts the Object x509CertificateHolder to X509Certificate using the Bouncy Castle library.
     *
     ...
     */
    public static X509Certificate x509CertificateHolderToX509Certificate(
            X509CertificateHolder x509CertificateHolder) throws CertificateException {
